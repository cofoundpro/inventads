...
define( 'CVIO_EXTRA_PLUGINS_DIRECTORY', 'https://bslthemes.com/plugins-latest/cvio/' );
...
function cvio_scripts() {
	...
	wp_enqueue_script( 'cvio-jquery-cookie', get_template_directory_uri() . '/assets/js/jquery.cookie.js', array('jquery'), '1.0.0', true );
