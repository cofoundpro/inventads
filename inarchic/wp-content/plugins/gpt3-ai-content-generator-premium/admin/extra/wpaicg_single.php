...
<div class="content-writer-master">
      ...
      <ul>
        <li>
          <a href="#express">
            ...
            <?php echo esc_html__('Express Mode','gpt3-ai-content-generator')?>
            </a>
        </li>
        <li>
          <a href="#custom">
            ...
            <?php echo esc_html__('Custom Mode','gpt3-ai-content-generator')?>
        </a>
        </li>
        <li>
          <a href="#playground">
            ...
            <?php echo esc_html__('Playground','gpt3-ai-content-generator')?>
            </a>
        </li>
        <li>
          <a href="#speechtopost">
            ...
            <?php echo esc_html__('Speech to Post','gpt3-ai-content-generator')?>
        </a>
        </li>
        <li>
          <a href="#logs">
            ...
            <?php echo esc_html__('Logs','gpt3-ai-content-generator')?>
        </a>
        </li>
      </ul>
    </nav>
  ...
  <main class="content-writer-master-content">
        ...
        <section id="expressdata">
            ...
            <div class="nice-form-group">
                ...
                <div class="nice-form-group" style="display: flex;">
                    <input type="text" id="wpai_preview_title" placeholder="<?php echo esc_html__('Title: e.g. Artificial Intelligence','gpt3-ai-content-generator')?>" name="_wporg_preview_title" value="<?php echo  esc_html( $_wporg_preview_title ) ; ?>">
                    <button type="button" name="get_preview" id="wpcgai_load_plugin_settings" class="button button-primary" style="margin-left: 1em;display: flex;align-items: center;"><?php echo esc_html__('Generate','gpt3-ai-content-generator')?></button>
                </div>
                <div class="nice-form-group">
                ...
                <div class="nice-form-group">
                    <button type="button" style="display:none;" name="action_save_draft" id="wpcgai_save_draft_post_action" class="button button-primary"><?php echo esc_html__('Save Draft','gpt3-ai-content-generator')?></button>
                </div>
            </div>
    ...
    <form action="" method="post" class="wpaicg_custom_template_form">
        <?php wp_nonce_field('wpaicg_custom_mode_generator'); ?>
        <section>
            ...
            <div class="nice-form-group">
                ...
                <div class="wpaicg_custom_template_add_topic">
                    <div class="nice-form-group">
                        <input class="wpaicg_template_topic" type="text" placeholder="<?php echo esc_html__('Topic: e.g. Artificial Intelligence','gpt3-ai-content-generator')?>">
                    </div>
                </div>
                <div class="wpaicg_custom_template_add_title" style="display: none">
                    <div class="nice-form-group">
                        <input type="text" class="wpaicg_template_title_field" placeholder="<?php echo esc_html__('Please enter a title','gpt3-ai-content-generator')?>">
                    </div>
                </div>
    ...
    <section>
        ...
        <div class="nice-form-group">
            ...
            <button class="button button-primary button-hero btn-start-record" style="display: inline-flex; align-items: center;" <?php echo ($wpaicg_provider != 'OpenAI') ? 'disabled' : ''; ?>><span class="dashicons dashicons-microphone"></span><?php echo esc_html__('Speak','gpt3-ai-content-generator')?></button>
            <button class="button button-primary button-hero btn-pause-record" style="display: none; align-items: center;" <?php echo ($wpaicg_provider != 'OpenAI') ? 'disabled' : ''; ?>><span class="dashicons dashicons-controls-pause"></span><?php echo esc_html__('Pause','gpt3-ai-content-generator')?></button>
            <button class="button button-link-delete button-hero btn-stop-record" style="display: none; align-items: center;" <?php echo ($wpaicg_provider != 'OpenAI') ? 'disabled' : ''; ?>><span class="dashicons dashicons-saved"></span><?php echo esc_html__('Stop','gpt3-ai-content-generator')?></button>
            <button class="button button-link-delete button-hero btn-abort-record" style="display: none; align-items: center;" <?php echo ($wpaicg_provider != 'OpenAI') ? 'disabled' : ''; ?>><span class="dashicons dashicons-no"></span><?php echo esc_html__('Cancel','gpt3-ai-content-generator')?></button>
            <!-- Not OpenAI -->
            <?php if ($wpaicg_provider != 'OpenAI'): ?>
                <p style="color:red;">
                    <?php echo esc_html__('"Speech to Post" module is only available with OpenAI. If you want to use this feature, go to Settings - AI Engine and change your provider to OpenAI.','gpt3-ai-content-generator')?>
                </p>
            <?php endif; ?>

            <p class="wpaicg-sending-record" style="display:none;width: 150px; text-align: left">
                <button class="button button-link-delete button-hero btn-cancel-record" style="display: inline-flex;color: #0b9529;"><span class="spinner" style="visibility: unset;margin: auto;"></span><?php echo esc_html__('Generating Content..Please Wait..','gpt3-ai-content-generator')?></button>
            </p>
            <p></p>
            ...
            <div class="wpaicg-speech-result" style="margin-top: 20px;display: none">
                <div class="nice-form-group">
                    <input type="text" class="wpaicg-speech-title" placeholder="<?php echo esc_html__('Enter a Post Title','gpt3-ai-content-generator')?>">
                </div>
                <div class="nice-form-group">
                    <strong><?php echo esc_html__('Post Content','gpt3-ai-content-generator')?></strong>
                </div>
                <div class="nice-form-group">
                    <?php
    ...
    <section>
        ...
        wp_editor('', 'wpaicg_generator_result', array(
            ...
            'textarea_rows' => 20, // Adjust the number of rows as needed
        ));
        ?>
    ...
    <section>
        ...
        ?>
        <p><?php echo esc_html__('Only the last 10 logs are displayed here.','gpt3-ai-content-generator')?></p>
        <div class="nice-form-group">
            <table class="wp-list-table widefat striped posts" style="white-space: normal;">
                ...
                <tr>
                    ...
                    <th><?php echo esc_html__('Word','gpt3-ai-content-generator')?></th>
                </tr>
                </thead>
                <tbody>
                <?php
    ...
    <div class="content-writer-right-navigation" id="right-nav-express" style="display: none;">
        <nav>
            <ul>
                <li>
                    <a href="javascript:void(0)" class="advanced-settings" ><?php echo esc_html__('Language & Behavior','gpt3-ai-content-generator')?></a>
                    <!-- Submenu for Language, Style and Tone -->
                    <div class="submenu" style="display: none;">
                        <div class="nice-form-group">
                            <label><?php echo esc_html( __( "Language", "gpt3-ai-content-generator" ) ) ;?></label>
                            <select name="_wporg_language" id="wpai_language">
                                <?php foreach ($languages as $value => $label) : ?>
                                    <option value="<?php echo esc_attr($value); ?>" <?php echo esc_attr($_wporg_language) === $value ? 'selected' : ''; ?>>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html( __( "Style", "gpt3-ai-content-generator" ) ) ;?></label>
                            <select name="_wporg_writing_style" id="wpai_writing_style">
                                <?php foreach ($styles as $value => $label) : ?>
                                    <option value="<?php echo esc_attr($value); ?>" <?php echo esc_attr($_wporg_writing_style) === $value ? 'selected' : ''; ?>>
                                        <?php echo esc_html($label); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html( __( "Tone", "gpt3-ai-content-generator" ) ) ;?></label>
                            <select name="_wporg_writing_tone" id="wpai_writing_tone">
                                <?php foreach ($tones as $value => $label) : ?>
                                    <option value="<?php echo esc_attr($value); ?>" <?php echo esc_attr($_wporg_writing_tone) === $value ? 'selected' : ''; ?>>
                                        <?php echo esc_html($label); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                ...
                <li>
                    <a href="javascript:void(0)" class="advanced-settings"><?php echo esc_html__('Headings','gpt3-ai-content-generator')?></a>
                    <!-- Submenu for Headings -->
                    <div class="submenu" style="display: none;">
                        <div class="nice-form-group">
                            <label><?php echo esc_html( __( "Number of Headings", "gpt3-ai-content-generator" ) ) ;?></label>
                            <input id="wpai_number_of_heading" name="_wporg_number_of_heading" type="range" min="1" max="15" value="<?php echo esc_attr($_wporg_number_of_heading); ?>" oninput="this.nextElementSibling.value = this.value">
                            <output for="wpai_number_of_heading"><?php echo esc_attr($_wporg_number_of_heading); ?></output>
                        </div>
                        <div class="nice-form-group">
                            <label><?php echo esc_html( __( "Heading Tag", "gpt3-ai-content-generator" ) ) ;?></label>
                            <select name="_wporg_heading_tag" id="wpai_heading_tag">
                                <?php foreach ($heading_tags as $label) : ?>
                                    <option value="<?php echo esc_attr($label); ?>" <?php echo (esc_html($_wporg_heading_tag) == $label) ? 'selected' : ''; ?>>
                                        <?php echo esc_html($label); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="nice-form-group">
                            <input type="checkbox" id="wpai_modify_headings2" name="_wporg_modify_headings2" value="<?php echo ( esc_html( $_wporg_modify_headings ) == 1 ? "1" : "0" ) ;?>" <?php echo ( esc_html( $_wporg_modify_headings ) == 1 ? "checked" : "" ) ; ?> />
                            <label><?php echo esc_html( __( "Outline Editor", "gpt3-ai-content-generator" ) ) ;?></label>
                            <input type="hidden" id="wpai_modify_headings" name="_wporg_modify_headings" value="<?php echo ( esc_html( $_wporg_modify_headings ) == 1 ? "1" : "0" ) ; ?>" />
                ...
                <li>
                    <a href="javascript:void(0)" class="advanced-settings" ><?php echo esc_html__('SEO','gpt3-ai-content-generator')?></a>
                    <!-- Submenu for SEO -->
                    <div class="submenu" style="display: none;">
                        <div class="nice-form-group">
                            <?php $_wpaicg_seo_meta_desc = get_option('_wpaicg_seo_meta_desc',false); ?>
                            <input <?php echo ( $_wpaicg_seo_meta_desc ? ' checked' : '' ) ; ?> type="checkbox" name="wpaicg_seo_meta_desc" id="wpaicg_seo_meta_desc" value="1" />
                        ...
                        <?php if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) { ?>
                            <input <?php echo $_wporg_add_keywords_bold == 1 ? ' checked':''?> type="checkbox" id="wpai_add_keywords_bold2" name="_wporg_add_keywords_bold2" value="1"/>
                            <label><?php echo esc_html__('Bold Keywords','gpt3-ai-content-generator'); ?></label>
                            <input type="hidden" id="wpai_add_keywords_bold" name="_wporg_add_keywords_bold" value="<?php echo esc_html($_wporg_add_keywords_bold)==1? "1" : "0";?>" />
                            <?php
                            } else {
                                ?>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Keywords to Include','gpt3-ai-content-generator'); ?></label>
                            <?php if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) { ?>
                            <input type="text" id="wpai_keywords" placeholder="<?php echo esc_html__('e.g. gpt, ai','gpt3-ai-content-generator')?>" name="_wporg_keywords" value="">
                            <small><?php echo esc_html__('Use comma to separate keywords','gpt3-ai-content-generator')?></small>
                            <?php
                            } else {
                                ?>
                            <input type="text" disabled id="wpai_keywords" placeholder="<?php echo esc_html__('Pro Feature','gpt3-ai-content-generator')?>" name="_wporg_keywords" value="">
                            <small><?php echo esc_html__('Use comma to separate keywords','gpt3-ai-content-generator')?></small>
                            <?php
                            }
                            ?>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Keywords to Avoid','gpt3-ai-content-generator'); ?></label>
                            <?php if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) { ?>
                            <input type="text" id="wpai_words_to_avoid" placeholder="<?php echo esc_html__('e.g. top, best','gpt3-ai-content-generator')?>" name="_wporg_words_to_avoid" value="">
                            <small><?php echo esc_html__('Use comma to separate keywords','gpt3-ai-content-generator')?></small>
                            <?php
                            } else {
                                ?>
                            <input type="text" disabled id="wpai_words_to_avoid" placeholder="<?php echo esc_html__('Pro Feature','gpt3-ai-content-generator')?>" name="_wporg_words_to_avoid" value="">
                            <small><?php echo esc_html__('Use comma to separate keywords','gpt3-ai-content-generator')?></small>
                            <?php
                            }
                            ?>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Tags','gpt3-ai-content-generator'); ?></label>
                            <input type="text" name="wpaicg_post_tags" id="wpaicg_post_tags" value="" />
                            <small><?php echo esc_html__('Use comma to seperate tags','gpt3-ai-content-generator')?></small>
                        </div>
                    </div>
                </li>
                <li>
                    <a href="javascript:void(0)" class="advanced-settings"><?php echo esc_html__('Image','gpt3-ai-content-generator')?></a>
                    <!-- Submenu for Image -->
                    <div class="submenu" style="display: none;">
                        <?php
                        ...
                        ?>
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Image','gpt3-ai-content-generator'); ?></label>
                            <select id="wpaicg_image_source" name="wpaicg_image_source" >
                                ...
                                <option <?php echo $wpaicg_image_source == 'dalle3' ? ' selected' : ''?> value="dalle3"><?php echo esc_html__('DALL-E 3','gpt3-ai-content-generator')?></option>
                                <option <?php echo $wpaicg_image_source == 'dalle3hd' ? ' selected' : ''?> value="dalle3hd"><?php echo esc_html__('DALL-E 3 HD','gpt3-ai-content-generator')?></option>
                                <option <?php echo $wpaicg_image_source == 'dalle' || ($wpaicg_image_source == 'pexels' && empty($wpaicg_pexels_api)) ? ' selected' : ''?> value="dalle"><?php echo esc_html__('DALL-E 2','gpt3-ai-content-generator')?></option>
                                ...
                                <!-- replicate -->
                                <option <?php echo $wpaicg_image_source == 'replicate' ? ' selected' : ''?> value="replicate"><?php echo esc_html__('Replicate','gpt3-ai-content-generator')?></option>
                            </select>
                        </div>
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Featured Image','gpt3-ai-content-generator')?></label>
                            <select id="wpaicg_featured_image_source" name="wpaicg_featured_image_source" >
                                <option value=""><?php echo esc_html__('None','gpt3-ai-content-generator')?></option>
                                <option <?php echo $wpaicg_featured_image_source == 'dalle3' ? ' selected' : ''?> value="dalle3"><?php echo esc_html__('DALL-E 3','gpt3-ai-content-generator')?></option>
                                <option <?php echo $wpaicg_featured_image_source == 'dalle3hd' ? ' selected' : ''?> value="dalle3hd"><?php echo esc_html__('DALL-E 3 HD','gpt3-ai-content-generator')?></option>
                                <option <?php echo $wpaicg_featured_image_source == 'dalle' || ($wpaicg_featured_image_source == 'pexels' && empty($wpaicg_pexels_api)) ? ' selected' : ''?> value="dalle"><?php echo esc_html__('DALL-E 2','gpt3-ai-content-generator')?></option>
                                ...
                                <!-- replicate -->
                                <option <?php echo $wpaicg_featured_image_source == 'replicate' ? ' selected' : ''?> value="replicate"><?php echo esc_html__('Replicate','gpt3-ai-content-generator')?></option>
                            </select>
                        </div>
                        <div class="nice-form-group" style="margin-bottom: 1em;">
                            <span class="smallbuttons" data-target="dalle"><?php echo esc_html__('DALL-E','gpt3-ai-content-generator')?></span>
                            <span class="smallbuttons" data-target="pexels"><?php echo esc_html__('Pexels','gpt3-ai-content-generator')?></span>
                            <span class="smallbuttons" data-target="pixabay"><?php echo esc_html__('Pixabay','gpt3-ai-content-generator')?></span>
                        </div>
                        <!-- Dall-E Settings -->
                        <div class="nice-form-group" id="dalle" style="display:none;">
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Image Size', 'gpt3-ai-content-generator')?></label>
                            ...
                            ?>
                                <label><?php echo esc_html__('Image Style','gpt3-ai-content-generator')?></label>
                            ...
                            ?>
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Artist','gpt3-ai-content-generator')?></label>
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Photography','gpt3-ai-content-generator')?></label>
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Lighting','gpt3-ai-content-generator')?></label>
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Subject','gpt3-ai-content-generator')?></label>
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Camera','gpt3-ai-content-generator')?></label>
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Composition','gpt3-ai-content-generator')?></label>
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Resolution','gpt3-ai-content-generator')?></label>
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Color','gpt3-ai-content-generator')?></label>
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Special Effects','gpt3-ai-content-generator')?></label>
                        ...
                        <div class="nice-form-group" id="pexels" style="display:none;">
                            <?php if (empty($wpaicg_pexels_api)) { ?>
                               <small><?php echo esc_html__('Your Pexels api key is not set.','gpt3-ai-content-generator')?></small>
                            <?php } ?>
                            <div class="nice-form-group">
                            ...
                            <div class="wpaicg-mb-10 wpaicg_pexels_custom_prompt" style="display:none">
                                <label><?php echo esc_html__('Custom Prompt','gpt3-ai-content-generator')?>:<small ><?php echo sprintf(esc_html__('Ensure %s is included in your prompt.','gpt3-ai-content-generator'),'<code>[title]</code>')?></small></label>
                        ...
                        <div class="nice-form-group" id="pixabay" style="display:none;">
                            <?php if (empty($wpaicg_pixabay_api)) { ?>
                               <small><?php echo esc_html__('Your Pixabay api key is not set.','gpt3-ai-content-generator')?></small>
                            <?php } ?>
                            <div class="nice-form-group">
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Image Type','gpt3-ai-content-generator')?></label>
                ...
                <li>
                    <a href="javascript:void(0)" class="advanced-settings"><?php echo esc_html__('Additional Content','gpt3-ai-content-generator')?></a>
                    ...
                    <div class="submenu" style="display: none;">
                        ...
                        ?>
                        <div class="nice-form-group">
                            <input type="checkbox" id="wpai_add_tagline2"  name="_wporg_add_tagline2" value="<?php echo ( esc_html( $_wporg_add_tagline ) == 1 ? "1" : "0" ) ; ?>" <?php echo ( esc_html( $_wporg_add_tagline ) == 1 ? "checked" : "" ) ; ?> />
                            <label><?php echo esc_html__('Tagline','gpt3-ai-content-generator')?></label>
                            <input type="hidden" id="wpai_add_tagline" name="_wporg_add_tagline" value="<?php echo ( esc_html( $_wporg_add_tagline ) == 1 ? "1" : "0" ) ; ?>" />
                        </div>
                        <div class="nice-form-group">
                            <input type="checkbox" id="wpai_add_intro2" name="_wporg_add_intro2" value="<?php echo ( esc_html( $_wporg_add_intro ) == 1 ? "1" : "0" ) ; ?>" <?php echo ( esc_html( $_wporg_add_intro ) == 1 ? "checked" : "" ) ;?> />
                            <label><?php echo esc_html__('Introduction','gpt3-ai-content-generator')?></label>
                            <input type="hidden" id="wpai_add_intro" name="_wporg_add_intro" value="<?php echo ( esc_html( $_wporg_add_intro ) == 1 ? "1" : "0" ) ; ?>" />
                        </div>
                        <div class="nice-form-group">
                        ...
                        <div class="nice-form-group">
                            <input type="checkbox" id="wpai_add_conclusion2" name="_wporg_add_conclusion2" value="<?php echo ( esc_html( $_wporg_add_conclusion ) == 1 ? "1" : "0" ) ; ?>" <?php echo ( esc_html( $_wporg_add_conclusion ) == 1 ? "checked" : "" ) ;?> />
                            <label><?php echo esc_html__('Conclusion','gpt3-ai-content-generator')?></label>
                            <input type="hidden" id="wpai_add_conclusion" name="_wporg_add_conclusion" value="<?php echo ( esc_html( $_wporg_add_conclusion ) == 1 ? "1" : "0" ) ; ?>" />
                        </div>
                        <div class="nice-form-group">
                        ...
                        <div class="nice-form-group">
                        <?php if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) { ?>
                            <input <?php echo $_wporg_add_faq ? ' checked':''?> type="checkbox" id="wpai_add_faq2" name="_wporg_add_faq2" value="1"/>
                            <label><?php echo esc_html__('Q & A','gpt3-ai-content-generator'); ?></label>
                            <input type="hidden" id="wpai_add_faq" name="_wporg_add_faq" value="1" />
                            <?php
                            } else {
                                ?>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Intro Title Tag','gpt3-ai-content-generator')?></label>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Conclusion Title Tag','gpt3-ai-content-generator');?></label>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('ToC Title Tag','gpt3-ai-content-generator');?></label>
                        ...
                        <div class="nice-form-group">
                            ...
                            <input type="text" value="<?php echo esc_html($wpaicg_toc_title)?>" name="wpaicg_toc_title" id="wpaicg_toc_title">
                        </div>
                    </div>
                </li>
                <li>
                    <a href="javascript:void(0)" class="advanced-settings"><?php echo esc_html__('Links','gpt3-ai-content-generator')?></a>
                    <!-- Submenu for Links -->
                    <div class="submenu" style="display: none;">
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Anchor Text','gpt3-ai-content-generator')?></label>
                            <input type="text" id="wpai_anchor_text" name="_wporg_anchor_text" value="<?php echo esc_html( $_wporg_anchor_text ) ; ?>">
                        </div>
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Target URL','gpt3-ai-content-generator')?></label>
                            <input type="url" id="wpai_target_url" placeholder="https://..." name="_wporg_target_url" value="<?php echo esc_html( $_wporg_target_url ) ; ?>">
                        </div>
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Call-to-Action','gpt3-ai-content-generator')?></label>
                            <input type="url" id="wpai_target_url_cta" placeholder="https://..." name="_wporg_target_url_cta" value="<?php echo esc_html( $_wporg_target_url_cta ) ; ?>">
                        </div>
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('CTA Position','gpt3-ai-content-generator')?></label>
                            <select name="_wporg_cta_pos" id="wpai_cta_pos">
                                <option value="beg" <?php echo ( esc_html( $_wporg_cta_pos ) == 'beg' ? 'selected' : '' ) ;?>><?php echo esc_html__('Beginning','gpt3-ai-content-generator')?></option>
                                <option value="end" <?php echo ( esc_html( $_wporg_cta_pos ) == 'end' ? 'selected' : '' ) ;?>><?php echo esc_html__('End','gpt3-ai-content-generator')?></option>
                            </select>
                        </div>
                    </div>
                </li>
                <li>
                    <a href="javascript:void(0)" class="advanced-settings"><?php echo esc_html__('Custom Prompt','gpt3-ai-content-generator')?></a>
                    ...
                    <div class="submenu" style="display: none;">
                        <div class="nice-form-group">
                            <input <?php echo $wpaicg_content_custom_prompt_enable ? ' checked':''?> type="checkbox" class="wpaicg_meta_custom_prompt_enable" name="wpaicg_custom_prompt_enable">
                        ...
                        <div class="nice-form-group">
                            <div class="wpaicg_meta_custom_prompt_box" style="<?php echo isset($wpaicg_content_custom_prompt_enable) && $wpaicg_content_custom_prompt_enable ? '':'display:none'?>">
                                ...
                                <?php endif; ?>
                                <button style="color: #fff;background: #df0707;border-color: #df0707;" data-prompt="<?php echo esc_html(\WPAICG\WPAICG_Custom_Prompt::get_instance()->wpaicg_default_custom_prompt)?>" class="button wpaicg_meta_custom_prompt_reset" type="button">
    ...
    <div class="content-writer-right-navigation" id="right-nav-custom" style="display: none;">
        <nav>
            <ul>
                <li>
                    <a href="javascript:void(0)" class="advanced-settings" ><?php echo esc_html__('Template','gpt3-ai-content-generator')?></a>
                    <!-- Submenu for Template -->
                    <div class="submenu">
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Template','gpt3-ai-content-generator')?></label>
                        ...
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Name','gpt3-ai-content-generator')?></label>
                            <input value="<?php echo esc_html($default_name)?>" type="text" class="wpaicg_custom_template_title" name="title" placeholder="<?php echo esc_attr__('Enter a Template Name', 'gpt3-ai-content-generator')?>">
                            <?php if(isset($selected_template) && !empty($selected_template)){ ?>
                ...
                <li>
                    <a href="javascript:void(0)" class="advanced-settings" ><?php echo esc_html__('Parameters','gpt3-ai-content-generator')?></a>
                    ...
                    <div class="submenu" style="display: none;">
                        ...
                        <div class="nice-form-group">
                            ...
                            <select name="template[model]" class="wpaicg_custom_template_model">
                                ...
                                ?>
                                <optgroup label="GPT-4"><?php display_options($gpt4_models, $wpaicg_parameters['model']); ?></optgroup>
                                <optgroup label="GPT-3.5"><?php display_options($gpt35_models, $wpaicg_parameters['model']); ?></optgroup>
                                <optgroup label="Custom Models"><?php display_options($custom_models, $wpaicg_parameters['model']); ?></optgroup>
                            </select>
                        </div>
                        <div class="nice-form-group" style="display:none;" id="azure-deployment-field">
                            <input type="text" name="template[azure_deployment]" class="wpaicg_custom_template_azure_deployment" value="<?php echo esc_attr($wpaicg_parameters['azure_deployment'])?>">
                        </div>
                        ...
                        <div class="nice-form-group" style="display:none;" id="google-models-field">
                            ...
                            <select name="template[google_model]" class="wpaicg_custom_template_google_model regular-text">
                                ...
                                ?>
                                    <option value="<?php echo esc_attr($model); ?>" <?php selected($model, $template_google_model); ?> <?php echo $shouldBeDisabled ? 'disabled' : ''; ?>>
                                        <?php echo esc_html(ucwords(str_replace('-', ' ', $model))); // Convert save format to display format ?>
                                    </option>
                                <?php endforeach; else: ?>
                            <option value="gemini-pro" <?php selected('gemini-pro', $template_google_model); ?>><?php echo esc_html__('Gemini Pro','gpt3-ai-content-generator')?></option>
                            <?php endif; ?>
                            </select>
                        </div>
                        ...
                        <div class="nice-form-group" style="display:none;" id="openrouter-models-field">
                            ...
                            <select name="template[openrouter_model]" class="wpaicg_custom_template_openrouter_model regular-text">
                                <?php foreach ($grouped_models as $provider => $models): ?>
                                    <optgroup label="<?php echo esc_attr($provider); ?>">
                                        ...
                                        foreach ($models as $model): ?>
                                            <option value="<?php echo esc_attr($model['id']); ?>" <?php selected($model['id'], $template_openrouter_model); ?>>
                        ...
                        <?php
                            ...
                            foreach($labels as $item => $label) {
                                ...
                                <div class="nice-form-group">
                                    ...
                                    <input type="text" value="<?php echo esc_attr($wpaicg_parameters[$item]); ?>" class="wpaicg_custom_template_<?php echo esc_attr($item); ?>" name="template[<?php echo esc_attr($item); ?>]">
                                </div>
                                <?php
                            }
                        ?>
                ...
                <li>
                    <a href="javascript:void(0)" class="advanced-settings" ><?php echo esc_html__('Prompts','gpt3-ai-content-generator')?></a>
                    <!-- Submenu for Prompts -->
                    <div class="submenu" style="display: none;">
                    <div class="wpaicg-custom-parameters">
                        <div class="nice-form-group">
                            <div class="wpaicg-custom-parameters-content">
                                <div class="nice-form-group">
                                    <label><?php echo esc_html__('Prompt for Title','gpt3-ai-content-generator')?></label>
                                    <textarea class="wpaicg_custom_template_prompt_title" name="template[prompt_title]" rows="3"><?php echo esc_html($wpaicg_parameters['prompt_title'])?></textarea>
                                    <small class="smallnotes">Ensure <code>[count]</code> and <code>[topic]</code> is included in your prompt.</small>
                                </div>
                                <div class="nice-form-group">
                                    <label><?php echo esc_html__('Prompt for Sections','gpt3-ai-content-generator')?></label>
                                    <textarea class="wpaicg_custom_template_prompt_section" name="template[prompt_section]" rows="5"><?php echo esc_html($wpaicg_parameters['prompt_section'])?></textarea>
                                    <small class="smallnotes">Ensure <code>[count]</code> and <code>[title]</code> is included in your prompt.</small>
                                </div>
                                <div class="nice-form-group">
                                    <label><?php echo esc_html__('Prompt for Content','gpt3-ai-content-generator')?></label>
                                    <textarea class="wpaicg_custom_template_prompt_content" name="template[prompt_content]" rows="15"><?php echo esc_html($wpaicg_parameters['prompt_content'])?></textarea>
                                    <small class="smallnotes">Ensure <code>[title]</code>, <code>[sections]</code> and <code>[count]</code> is included in your prompt.</small>
                                </div>
                                <div class="nice-form-group">
                                    <label><?php echo esc_html__('Prompt for Excerpt','gpt3-ai-content-generator')?></label>
                                    <textarea class="wpaicg_custom_template_prompt_excerpt" name="template[prompt_excerpt]" rows="3"><?php echo esc_html($wpaicg_parameters['prompt_excerpt'])?></textarea>
                                    <small class="smallnotes">Ensure <code>[title]</code> is included in your prompt.</small>
                                </div>
                                <div class="nice-form-group">
                                    <label><?php echo esc_html__('Prompt for Meta','gpt3-ai-content-generator')?></label>
                                    <textarea class="wpaicg_custom_template_prompt_meta" name="template[prompt_meta]" rows="3"><?php echo esc_html($wpaicg_parameters['prompt_meta'])?></textarea>
                                    <small class="smallnotes">Ensure <code>[title]</code> is included in your prompt.</small>
                                </div>
                            </div>
                        </div>
            ...
            <div style="display: flex;justify-content: space-between">
                <div>
                    ...
                    <button type="button" class="button button-primary wpaicg_template_save"><?php echo esc_html__('Save','gpt3-ai-content-generator')?></button>
    ...
    <div class="content-writer-right-navigation" id="right-nav-playground" style="display: none;">
        <nav>
            <ul>
                <li>
                    <a href="javascript:void(0)" class="advanced-settings" ><?php echo esc_html__('Settings','gpt3-ai-content-generator')?></a>
                    <!-- Submenu for Language, Style and Tone -->
                    <div class="submenu">
                        <div class="nice-form-group">
                            <select id="provider_select">
                                ...
                                <option value="openrouter"><?php echo esc_html__('OpenRouter', 'gpt3-ai-content-generator') ?></option>
                        ...
                        <div id="api_key_field_togetherai" style="display: none;">
                            <div class="nice-form-group">
                                <input type="text" id="togetherai_api_key" placeholder="Enter your Together AI API key" value="<?php echo esc_attr(get_option('wpaicg_togetherai_model_api_key')); ?>">
                            </div>
                            <div class="nice-form-group">
                        ...
                        <div class="nice-form-group">
                            <select id="category_select">
                                ...
                                ?>
                                <?php foreach ($playground_categories as $value => $label) : ?>
                                    <option value="<?php echo esc_attr($value); ?>"><?php echo esc_html__($label, 'gpt3-ai-content-generator'); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="nice-form-group">
                        ...
                        <div class="nice-form-group">
                            <textarea type="text" rows="10" class="wpaicg_prompt"><?php echo esc_html__('Write a blog post on how to effectively monetize a blog, discussing various methods such as affiliate marketing, sponsored content, and display advertising, as well as tips for maximizing revenue.', 'gpt3-ai-content-generator') ?></textarea>
                        </div>
                        <div class="nice-form-group">
                        <button class="button button-primary wpaicg_generator_button"><span class="spinner"></span><?php echo esc_html__('Generate', 'gpt3-ai-content-generator') ?></button>
    ...
    jQuery(document).ready(function ($){
        ...
        function wpaicgSaveTemplate(e){
            ...
            if(!has_error && model === 'gpt-4o' && (max_tokens > 8192 || max_tokens < 0)){
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For gpt-4o, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'),0,8192)?>';
            }
            if(!has_error && model === 'gpt-4o-mini' && (max_tokens > 8192 || max_tokens < 0)){
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For gpt-4o-mini, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'),0,8192)?>';
            }
            ...
            if (!has_error && model === 'gpt-4-turbo' && (max_tokens > 128000 || max_tokens < 0)) {
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For gpt-4-turbo, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'), 0, 128000) ?>';
            }
                ...
                wpaicgSpeechAjaxRequest = $.ajax({
                    ...
                    success: function (res){
                        ...
                        if(res.status === 'success'){
                            ...
                            wpaicgSpeechMessage.html('<p><strong><?php echo esc_html__('Your Prompt','gpt3-ai-content-generator')?>: </strong><span style="font-style: italic">'+res.text+'</span></p>');
...
<script>
    var openaiModels = <?php echo json_encode($openai_models); ?>;
    jQuery(document).ready(function ($){
        // Define the prompts
        var prompts = [
        ...
        function fetchOpenRouterModels() {
            const openrouterModels = <?php echo json_encode(get_option('wpaicg_openrouter_model_list', [])); ?>;
            var modelOptions = {};
        ...
        $('.wpaicg_generator_button').click(function(){
            ...
            if(selectedProvider === 'openai' || selectedProvider === 'openrouter'){
                ...
                eventGenerator = new EventSource('<?php echo esc_html(add_query_arg('wpaicg_stream', 'yes', site_url() . '/index.php')); ?>&title='+title+'&nonce=<?php echo wp_create_nonce('wpaicg-ajax-nonce') ?>'+'&engine='+selectedModel+'&provider='+selectedProvider + '&source=playground');
