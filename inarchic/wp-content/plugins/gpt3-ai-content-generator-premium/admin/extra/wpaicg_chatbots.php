...
$wpaicg_chat_copy_btn = false;
$wpaicg_chat_feedback_btn = false;
            ...
            <form action="" method="post" class="wpaicg-bot-form">
                ...
                <div class="wpaicg-bot-style wpaicg-bot-wizard" style="display: none">
                    ...
                    <div class="nice-form-group" style="display: flex;justify-content: space-between;margin-top: -1em;">
                        ...
                        <div class="nice-form-group" style="flex: 1; padding-right: 3px;">
                            <label style="font-size: 11px;"><?php echo esc_html__('Height','gpt3-ai-content-generator')?></label>
                            <input style="width: 55px;font-size: 11px;height: 32px;" value="60" type="number" min="30" class="wpaicg_chatbot_text_height" name="bot[text_height]">
                        </div>
                        <div class="nice-form-group" style="flex: 1;">
                            <label style="font-size: 11px;"><?php echo esc_html__('Radius','gpt3-ai-content-generator')?></label>
                ...
                <div class="wpaicg-bot-parameters wpaicg-bot-wizard" style="display: none">
                    ...
                    <legend><?php echo esc_html__('Options', 'gpt3-ai-content-generator'); ?></legend>
                        <div class="nice-form-group">
                            <input name="bot[internet_browsing]" class="wpaicg_chatbot_internet_browsing" value="1" type="checkbox">
                ...
                <div class="wpaicg-bot-audio wpaicg-bot-wizard" style="display: none">
                    <h3 style="margin-top: -0.2em;"><?php echo esc_html__('Speech','gpt3-ai-content-generator')?></h3>
                        ...
                        <!-- Allow users to switch voice on/off audio_btn -->
                        <div class="nice-form-group">
                            <input class="wpaicg_chatbot_audio_btn" value="1" type="checkbox" name="bot[audio_btn]">
                            <label><?php echo esc_html__('Allow users to switch voice on/off','gpt3-ai-content-generator')?></label>
                        </div>
                        <div class="nice-form-group">
                            <input class="wpaicg_chatbot_muted_by_default" value="1" type="checkbox" name="bot[muted_by_default]">
                            <label><?php echo esc_html__('Muted by default','gpt3-ai-content-generator')?></label>
                        </div>
                        <div class="nice-form-group">
                    ...
                    <div class="nice-form-group">
                        ...
                        <select name="bot[openai_model]" class="wpaicg_chatbot_openai_model">
                            <option value="tts-1" <?php echo $wpaicg_openai_model == 'tts-1' ? 'selected' : ''; ?>>tts-1 (Fastest)</option>
                            <option value="tts-1-hd" <?php echo $wpaicg_openai_model == 'tts-1-hd' ? 'selected' : ''; ?>>tts-1-hd (Highest Quality)</option>
                        </select>
                    </div>
                    <div class="nice-form-group" style="display: flex; gap:20px">
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Voice','gpt3-ai-content-generator')?></label>
                            <select name="bot[openai_voice]" class="wpaicg_chatbot_openai_voice" style="width: 100%">
                        ...
                        <div class="nice-form-group">
                            ...
                            <select name="bot[openai_output_format]" class="wpaicg_chatbot_openai_output_format" style="width: 100%">
                        ...
                        <div class="nice-form-group">
                            ...
                            <input type="number" min="0.25" max="4.0" step="0.25" value="1" name="bot[openai_voice_speed]" class="wpaicg_chatbot_openai_voice_speed" style="width: 100%">
                        </div>
                    </div>
                </div>
                    ...
                    ?>
                        ...
                        <div class="nice-form-group" style="display: flex; gap:20px">
                            <div class="nice-form-group">
                                ...
                                <select <?php echo empty($wpaicg_google_api_key) ? ' disabled':''?> name="bot[voice_device]" class="wpaicg_chatbot_voice_device" style="width: 100%">
                                    <?php
                            ...
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Speed','gpt3-ai-content-generator')?></label>
                                <input <?php echo empty($wpaicg_google_api_key) ? ' disabled':''?> type="text" class="wpaicg_voice_speed wpaicg_chatbot_voice_speed" value="<?php echo esc_html($wpaicg_voice_speed)?>" name="bot[voice_speed]" style="width: 100%">
                            </div>
                            <div class="nice-form-group">
                                <label><?php echo esc_html__('Pitch','gpt3-ai-content-generator')?>:</label>
                                <input <?php echo empty($wpaicg_google_api_key) ? ' disabled':''?> type="text" class="wpaicg_voice_pitch wpaicg_chatbot_voice_pitch" value="<?php echo esc_html($wpaicg_voice_pitch)?>" name="bot[voice_pitch]" style="width: 100%">
                            </div>
                        </div>
                    </div>
                    <?php
                ...
                <div class="wpaicg-bot-custom wpaicg-bot-wizard" style="display: none">
                    ...
                    <div class="nice-form-group" style="margin-top: -1em;">
                        <fieldset class="nice-form-group" style="display: flex; flex-wrap: wrap; gap: 10px;">                   
                            <div class="nice-form-group" style="flex: 1 1 30%;">
                            ...
                            <div class="nice-form-group" style="flex: 1 1 30%;">
                                <input <?php echo $wpaicg_chat_copy_btn ? ' checked' : ''; ?> value="1" type="checkbox" class="wpaicg_chatbot_copy_btn" name="bot[copy_btn]">
                                <label style="font-size: 11px;"><?php echo esc_html__('Copy', 'gpt3-ai-content-generator'); ?></label>
                            </div>

                            <div class="nice-form-group" style="flex: 1 1 30%;">
                                <input <?php echo $wpaicg_chat_feedback_btn ? ' checked' : ''; ?> value="1" type="checkbox" class="wpaicg_chatbot_feedback_btn" name="bot[feedback_btn]">
                                <label style="font-size: 11px;"><?php echo esc_html__('Feedback', 'gpt3-ai-content-generator'); ?></label>
                            </div>
                    ...
                    <div class="nice-form-group" style="display: flex; flex-wrap: wrap; gap: 10px;">
                        <div class="nice-form-group" style="flex: 1 1 100%;">
                            <label><?php echo esc_html__('Welcome Message','gpt3-ai-content-generator')?></label>
                            <input style="width: 100%;" type="text" class="wpaicg_chatbot_welcome" name="bot[welcome]" value="<?php echo esc_html__('Hello, how can I help you today?','gpt3-ai-content-generator')?>" >
                        </div>
                        <div class="nice-form-group" style="flex: 1 1 48%;">
                        ...
                        <div class="nice-form-group" style="flex: 1 1 48%;">
                            ...
                            <input style="width: 100%;" type="text" class="wpaicg_chatbot_feedback_title" name="bot[feedback_title]" value="<?php echo esc_html__('Feedback', 'gpt3-ai-content-generator'); ?>">
                        </div>

                        <div class="nice-form-group" style="flex: 1 1 48%;">
                            <label><?php echo esc_html__('Feedback Message','gpt3-ai-content-generator'); ?></label>
                            <input style="width: 100%;" type="text" class="wpaicg_chatbot_feedback_message" name="bot[feedback_message]" value="<?php echo esc_html__('Please provide details: (optional)', 'gpt3-ai-content-generator'); ?>">
                        </div>

                        <div class="nice-form-group" style="flex: 1 1 48%;">
                            <label><?php echo esc_html__('Feedback Success','gpt3-ai-content-generator'); ?></label>
                            <input style="width: 100%;" type="text" class="wpaicg_chatbot_feedback_success" name="bot[feedback_success]" value="<?php echo esc_html__('Thank you for your feedback!', 'gpt3-ai-content-generator'); ?>">
                        </div>
                    </div>
                    <div class="wpaicg-bot-footer">
                        <div>
                ...
                <div class="wpaicg-bot-context wpaicg-bot-wizard" style="display: none">
                    ...
                    <div class="nice-form-group">
                        ...
                        <input id="wpaicg_chatbot_confidence_score" name="bot[confidence_score]" type="range" step="1" min="1" max="100" style="width: 42%;" value="<?php echo isset($bot['confidence_score']) ? esc_attr($bot['confidence_score']) : 20; ?>" oninput="this.nextElementSibling.value = this.value">
                        <output><?php echo isset($bot['confidence_score']) ? esc_attr($bot['confidence_score']) : 20; ?></output>
                    </div>
                        ...
                        <ul class="wpaicg-chat-shortcode-messages" style="height: <?php echo esc_html($wpaicg_chat_height)?>">
                            ...
                            <li class="wpaicg-ai-message" style="color: <?php echo esc_html($wpaicg_chat_fontcolor)?>; font-size: <?php echo esc_html($wpaicg_chat_fontsize)?>px; background-color: <?php echo esc_html($wpaicg_ai_bg_color);?>">
                                <p>
                                    ...
                                    <span class="wpaicg-chat-message wpaicg_chatbot_welcome_message"><?php echo esc_html__('Hello, how can I help you today?','gpt3-ai-content-generator')?></span>
                                </p>
                            </li>
                        </ul>
                    </div>
    ...
    jQuery(document).ready(function ($){
        ...
        function checkAndHandleStreaming() {
            ...
            if (isStreamingEnabled) {
                ...
                // wpaicg_chatbot_audio_btn uncheck and disable
                $('.wpaicg_chatbot_audio_btn').prop('checked', false);
                $('.wpaicg_chatbot_audio_btn').attr('disabled', 'disabled');
                // wpaicg_chatbot_muted_by_default uncheck and disable
                $('.wpaicg_chatbot_muted_by_default').prop('checked', false);
                $('.wpaicg_chatbot_muted_by_default').attr('disabled', 'disabled');
            } else {
                ...
                $('.wpaicg_chatbot_audio_btn').removeAttr('disabled');
                $('.wpaicg_chatbot_muted_by_default').removeAttr('disabled');
            }
        }
        ...
        $(document).on('change', '.wpaicg_chatbot_model', function() {
            ...
            if (isStreamingEnabled) {
                ...
                let selectedModel = $(this).val();
                 // gpt-4-vision-preview or gpt-4o or gpt-4o-mini	
                if (selectedModel !== 'gpt-4-vision-preview' && selectedModel !== 'gpt-4o' && selectedModel !== 'gpt-4o-mini') {
                    $('.wpaicg_chatbot_image_enable').prop('checked', false);
                    $('.wpaicg_chatbot_image_enable').attr('disabled', 'disabled');
                } else {
                    $('.wpaicg_chatbot_image_enable').removeAttr('disabled');
        ...
        $('.wpaicg-create-bot').click(function (){
            ...
            // Initialize Internet Browsing option
            if ($('.wpaicg_modal_content .wpaicg_chatbot_internet_browsing').is(':checked')) {
                $('.wpaicg_modal_content .wpaicg_chatbot_internet_browsing').prop('checked', true);
            } else {
                $('.wpaicg_modal_content .wpaicg_chatbot_internet_browsing').prop('checked', false);
            }
            wpaicgChatInit();
        });
        ...
        $('.wpaicg-bot-edit').click(function (){
            ...
            $('.wpaicg_modal_content').html($('.wpaicg-create-bot-default').html());
            let modalContent = $('.wpaicg_modal_content');
            // Set Internet Browsing option
            if (fields.internet_browsing && fields.internet_browsing === '1') {
                modalContent.find('.wpaicg_chatbot_internet_browsing').prop('checked', true);
            } else {
                modalContent.find('.wpaicg_chatbot_internet_browsing').prop('checked', false);
            }
            ...
            // append confidence_score value to wpaicg_chatbot_confidence_score
            if (fields.confidence_score) {
                let confidenceScoreInput = modalContent.find('#wpaicg_chatbot_confidence_score');
                let confidenceScoreOutput = confidenceScoreInput.next('output');

                // Set the value for the range input
                confidenceScoreInput.val(fields.confidence_score);
            ...
            $.each(fields, function (key, field){
                ...
                else if((key === 'fullscreen' || key === 'embedding_pdf' || key === 'chat_to_speech' || key === 'close_btn' || key === 'audio_btn' || key === 'muted_by_default' || key === 'download_btn' || key === 'clear_btn' || key === 'copy_btn' || key === 'feedback_btn' || key === 'openai_stream_nav' || key === 'log_request' || key === 'audio_enable' || key === 'image_enable' || key === 'moderation' || key === 'use_avatar' || key === 'chat_addition' || key === 'save_logs' || key === 'log_notice') && field === '1'){
                    if(key === 'save_logs'){
