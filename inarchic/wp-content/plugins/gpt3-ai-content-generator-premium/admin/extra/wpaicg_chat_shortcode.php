...
if(isset($_POST['wpaicg_chat_shortcode_options']) && is_array($_POST['wpaicg_chat_shortcode_options'])){
    ...
    // Explicitly check for 'internet_browsing' and set it based on whether the checkbox was checked
    $posted_options['internet_browsing'] = isset($_POST['wpaicg_chat_shortcode_options']['internet_browsing']) ? 1 : 0;

    // Handle checkboxes: set to true if checked, false if not
    $posted_options['fullscreen'] = isset($posted_options['fullscreen']) ? true : false;
    $posted_options['download_btn'] = isset($posted_options['download_btn']) ? true : false;
    $posted_options['clear_btn'] = isset($posted_options['clear_btn']) ? true : false;
    $posted_options['copy_btn'] = isset($posted_options['copy_btn']) ? true : false;
    $posted_options['feedback_btn'] = isset($posted_options['feedback_btn']) ? true : false;
    $posted_options['audio_btn'] = isset($posted_options['audio_btn']) ? true : false;
    $posted_options['muted_by_default'] = isset($posted_options['muted_by_default']) ? true : false;
    // If feedback button is enabled, also enable save_logs
    if ($posted_options['feedback_btn']) {
        $posted_options['save_logs'] = true;
    }
...
// Retrieve the saved confidence score or use the default value
$confidence_score = isset($wpaicg_chat_shortcode_options['confidence_score']) ? $wpaicg_chat_shortcode_options['confidence_score'] : 20;
...
$wpaicg_chat_muted_by_default = isset($wpaicg_settings['muted_by_default']) && !empty($wpaicg_settings['muted_by_default']) ? $wpaicg_settings['muted_by_default'] : false;
    ...
    <main class="demo-page-content">
        <form action="" method="post" id="form-chatbox-setting">
            ...
            <section id="aisettings" class="tab-content">
                ...
                <div class="nice-form-group">
                    <label style="display: flex; align-items: center;">
                        <?php echo esc_html__('AI Provider', 'gpt3-ai-content-generator') ?>
                        <a href="https://docs.aipower.org/docs/category/ai-engines" target="_blank" style="text-decoration: none; margin-left: 5px;">
                ...
                <div class="openai-models">
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            ...
                            <a href="https://docs.aipower.org/docs/ai-engine/openai/gpt-models" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                ...
                <div class="google-models" style="display: none;">
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Model', 'gpt3-ai-content-generator') ?>
                            <a href="https://docs.aipower.org/docs/ai-engine/google" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                ...
                <div class="azure-models" style="display: none;">
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Deployment', 'gpt3-ai-content-generator') ?>
                            <a href="https://docs.aipower.org/docs/ai-engine/azure-openai" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                ...
                <div class="openrouter-models" style="display: none;">
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Model', 'gpt3-ai-content-generator') ?>
                            <a href="https://docs.aipower.org/docs/ai-engine/openrouter" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                ...
                <div class="nice-form-group" style="display: flex; align-items: center;">
                        <input <?php echo isset($wpaicg_settings['internet_browsing']) && $wpaicg_settings['internet_browsing'] ? ' checked': ''?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[internet_browsing]" id="wpaicg_internet_browsing">
                        <label for="wpaicg_internet_browsing" style="margin-left: 5px;">
                            <?php echo esc_html__('Internet Browsing','gpt3-ai-content-generator')?>
                        </label>
                        
                        <a href="https://docs.aipower.org/docs/ChatGPT/advanced-setup/internet-browsing" target="_blank" style="text-decoration: none; margin-left: 5px;">
                            <span class="dashicons dashicons-editor-help"></span>
                        </a>
                    </div>
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        ...
                        <label for="wpaicg_stream_nav_option" style="margin-left: 5px;">
                            <?php echo esc_html__('Streaming','gpt3-ai-content-generator')?>
                        </label>
                        <a href="https://docs.aipower.org/docs/ChatGPT/advanced-setup/streaming" target="_blank" style="text-decoration: none; margin-left: 5px;">
                            <span class="dashicons dashicons-editor-help"></span>
                        </a>
                    </div>
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        ...
                        <label for="wpaicg_image_enable" style="margin-left: 5px;">
                            <?php echo esc_html__('Image Upload','gpt3-ai-content-generator')?>
                        </label>
                        <a href="https://docs.aipower.org/docs/ChatGPT/advanced-setup/image-upload" target="_blank" style="text-decoration: none; margin-left: 5px;">
                            <span class="dashicons dashicons-editor-help"></span>
                        </a>
                    </div>
                    <?php 
                    ...
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        ...
                        <label for="wpaicg_chat_addition" style="margin-left: 5px;">
                            <?php echo esc_html__('Custom Instructions','gpt3-ai-content-generator')?>
                        </label>
                        <a href="https://docs.aipower.org/docs/ChatGPT/advanced-setup/context#custom-instructions" target="_blank" style="text-decoration: none; margin-left: 5px;">
                            <span class="dashicons dashicons-editor-help"></span>
                        </a>
                    </div>
                </fieldset>
                ...
                <div id="wpaicg-advanced-settings" style="display: none;">
                    <div class="nice-form-group">
                    <label style="display: flex; align-items: center;">
                        <?php echo esc_html__('Temperature', 'gpt3-ai-content-generator') ?>
                        <a href="https://docs.aipower.org/docs/ai-engine/openai/temperature" target="_blank" style="text-decoration: none; margin-left: 5px;">
                            <span class="dashicons dashicons-editor-help"></span>
                        </a>
                    </label>
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Max Tokens', 'gpt3-ai-content-generator') ?>
                            <a href="https://docs.aipower.org/docs/ai-engine/openai/max-tokens" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Top P', 'gpt3-ai-content-generator') ?>
                            <a href="https://docs.aipower.org/docs/ai-engine/openai/top-p" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Frequency Penalty', 'gpt3-ai-content-generator') ?>
                            <a href="https://docs.aipower.org/docs/ai-engine/openai/frequency-penalty" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Presence Penalty', 'gpt3-ai-content-generator') ?>
                            <a href="https://docs.aipower.org/docs/ai-engine/openai/presence-penalty" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
            ...
            <section id="customtext" class="tab-content" style="display: none;">
                ...
                <fieldset style="margin-top: -1em;" class="nice-form-group">
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        <input <?php echo isset($wpaicg_chat_fullscreen) && $wpaicg_chat_fullscreen ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[fullscreen]" id="wpaicgchat_fullscreen">
                        <label for="wpaicgchat_fullscreen" style="margin-left: 5px;">
                            <?php echo esc_html__('Fullscreen','gpt3-ai-content-generator')?>
                        </label>
                    </div>
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        <input <?php echo isset($wpaicg_chat_download_btn) && $wpaicg_chat_download_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[download_btn]" id="wpaicgchat_download_btn">
                        <label for="wpaicgchat_download_btn" style="margin-left: 5px;">
                            <?php echo esc_html__('Download','gpt3-ai-content-generator')?>
                        </label>
                    </div>
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        <input <?php echo isset($wpaicg_chat_clear_btn) && $wpaicg_chat_clear_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[clear_btn]" id="wpaicgchat_clear_btn">
                        <label for="wpaicgchat_clear_btn" style="margin-left: 5px;">
                            <?php echo esc_html__('Clear','gpt3-ai-content-generator')?>
                        </label>
                    </div>
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        <input <?php echo isset($wpaicg_chat_copy_btn) && $wpaicg_chat_copy_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[copy_btn]" id="wpaicgchat_copy_btn">
                        <label for="wpaicgchat_copy_btn" style="margin-left: 5px;">
                            <?php echo esc_html__('Copy','gpt3-ai-content-generator')?>
                        </label>
                    </div>
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        <input <?php echo isset($wpaicg_chat_feedback_btn) && $wpaicg_chat_feedback_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[feedback_btn]" id="wpaicgchat_feedback_btn">
                        <label for="wpaicgchat_feedback_btn" style="margin-left: 5px;">
                            <?php echo esc_html__('Feedback','gpt3-ai-content-generator')?>
                        </label>
                    </div>
                    <div class="nice-form-group" style="display: flex; align-items: center;">
                        <input <?php echo isset($wpaicg_settings['use_avatar']) && $wpaicg_settings['use_avatar'] ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[use_avatar]" id="wpaicg_chat_shortcode_use_avatar" class="wpaicg_chat_shortcode_use_avatar">
                        <label for="wpaicg_chat_shortcode_use_avatar" style="margin-left: 5px;">
                            <?php echo esc_html__('Avatar (40x40)','gpt3-ai-content-generator')?>
                        </label>
                    </div>
                </fieldset>
                <div id="avatar-section">
                    <div class="nice-form-group" style="display: flex; align-items: center; justify-content: space-between;">
                ...
                <div class="nice-form-group">
                    <label><?php echo esc_html__('Feedback Title','gpt3-ai-content-generator')?></label>
                    <input value="<?php echo esc_html($wpaicg_settings['feedback_title'])?>" type="text" name="wpaicg_chat_shortcode_options[feedback_title]" placeholder="<?php echo esc_html__('Feedback','gpt3-ai-content-generator')?>">
                </div>
                <div class="nice-form-group">
                    <label><?php echo esc_html__('Feedback Message','gpt3-ai-content-generator')?></label>
                    <input value="<?php echo esc_html($wpaicg_settings['feedback_message'])?>" type="text" name="wpaicg_chat_shortcode_options[feedback_message]" placeholder="<?php echo esc_html__('Please provide details: (optional)','gpt3-ai-content-generator')?>">
                </div>
                <div class="nice-form-group">
                    <label><?php echo esc_html__('Feedback Success Message','gpt3-ai-content-generator')?></label>
                    <input value="<?php echo esc_html($wpaicg_settings['feedback_success'])?>" type="text" name="wpaicg_chat_shortcode_options[feedback_success]" placeholder="<?php echo esc_html__('Thank you for your feedback!','gpt3-ai-content-generator')?>">
                </div>
                <details>
                    <summary>
                        <button class="button button-primary wpaicg-w-25"><?php echo esc_html__('Save','gpt3-ai-content-generator')?></button>
            ...
            <section id="knowledge" class="tab-content" style="display: none;">
                ...
                <div class="nice-form-group" style="display: flex;justify-content: space-between;">
                    <div class="nice-form-group" style="margin-right: 5px;">
                        <label style="display: flex; align-items: center;">
                            ...
                            <a href="https://docs.aipower.org/docs/ChatGPT/advanced-setup/context#vector-db-selection" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                    ...
                    <div class="nice-form-group" style="margin-right: 5px;">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Index', 'gpt3-ai-content-generator'); ?>
                            <a href="https://docs.aipower.org/docs/embeddings#vector-db" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                    ...
                    <div class="nice-form-group" style="margin-right: 5px;">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Collection', 'gpt3-ai-content-generator'); ?>
                            <a href="https://docs.aipower.org/docs/embeddings#vector-db" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                    ...
                    <div class="nice-form-group">
                        <label style="display: flex; align-items: center;">
                            <?php echo esc_html__('Limit', 'gpt3-ai-content-generator'); ?>
                            <a href="https://docs.aipower.org/docs/ChatGPT/advanced-setup/context#limit" target="_blank" style="text-decoration: none; margin-left: 5px;">
                                <span class="dashicons dashicons-editor-help"></span>
                            </a>
                        </label>
                ...
                <div class="nice-form-group">
                    <label style="display: flex; align-items: center;">
                        <?php echo esc_html__('Confidence Score Threshold', 'gpt3-ai-content-generator') ?>
                        <a href="https://docs.aipower.org/docs/ChatGPT/advanced-setup/context#confidence-score-threshold" target="_blank" style="text-decoration: none; margin-left: 5px;">
                            <span class="dashicons dashicons-editor-help"></span>
                        </a>
                    </label>
                    <input id="wpaicg_confidence_score" name="wpaicg_chat_shortcode_options[confidence_score]" type="range" step="1" min="1" max="100" value="<?php echo isset($wpaicg_chat_shortcode_options['confidence_score']) ? esc_attr($wpaicg_chat_shortcode_options['confidence_score']) : 20; ?>" oninput="this.nextElementSibling.value = this.value">
                    <output><?php echo isset($wpaicg_chat_shortcode_options['confidence_score']) ? esc_attr($wpaicg_chat_shortcode_options['confidence_score']) : 20; ?></output>
                </div>
                <div class="nice-form-group" style="display: flex; justify-content: space-between; margin-top: 1em;">
            ...
            <section id="speech" class="tab-content" style="display: none;">
                ...
                <!-- User Voice Switch -->
                <div class="nice-form-group" style="display: flex; align-items: center;">
                    <input <?php echo isset($wpaicg_chat_audio_btn) && $wpaicg_chat_audio_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[audio_btn]" id="wpaicgchat_audio_btn" <?php echo $wpaicg_chat_to_speech ? '' : 'disabled'; ?>>
                    <label for="wpaicgchat_audio_btn" style="margin-left: 5px;">
                        <?php echo esc_html__('Allow users to switch voice on/off','gpt3-ai-content-generator')?>
                    </label>
                </div>
                <div class="nice-form-group" style="display: flex; align-items: center;">
                    <input <?php echo isset($wpaicg_chat_muted_by_default) && $wpaicg_chat_muted_by_default ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[muted_by_default]" id="wpaicgchat_muted_by_default" <?php echo $wpaicg_chat_to_speech ? '' : 'disabled'; ?>>
                    <label for="wpaicgchat_muted_by_default" style="margin-left: 5px;">
                        <?php echo esc_html__('Muted by default','gpt3-ai-content-generator')?>
                    </label>
                </div>
                <?php
                ...
                <div class="wpaicg_voice_service_openai" style="<?php echo $wpaicg_chat_voice_service == 'openai' ? '' : 'display:none'?>">
                    <div class="nice-form-group">
                        ...
                        <select name="wpaicg_chat_shortcode_options[openai_model]" id="wpaicg_openai_model" class="wpaicg_openai_model" <?php echo $disabled_voice_fields ? 'disabled' : ''; ?>>
                            <option value="tts-1" <?php echo $wpaicg_openai_model == 'tts-1' ? 'selected' : ''; ?>><?php echo esc_html__('tts-1 (Fastest)','gpt3-ai-content-generator')?></option>
                            <option value="tts-1-hd" <?php echo $wpaicg_openai_model == 'tts-1-hd' ? 'selected' : ''; ?>><?php echo esc_html__('tts-1-hd (Highest Quality)','gpt3-ai-content-generator')?></option>
                        </select>
                    </div>
                    <div class="nice-form-group" style="display: flex; justify-content: space-between; align-items: center;">
                        <div class="nice-form-group">
                        ...
                        <div class="nice-form-group">
                            <label for="wpaicg_openai_voice_speed"><?php echo esc_html__('Speed', 'gpt3-ai-content-generator'); ?></label>
                ...
                <div class="wpaicg_voice_service_google" style="<?php echo $wpaicg_chat_voice_service == 'google' && (!empty($wpaicg_google_api_key) || !empty($wpaicg_elevenlabs_api)) ? '' : 'display:none'?>">
                    ...
                    <div class="nice-form-group" style="display: flex; gap: 20px; align-items: center;">
                        <div class="nice-form-group">
                            <label for="wpaicg_voice_device"><?php echo esc_html__('Device','gpt3-ai-content-generator')?></label>
...
<script>
    jQuery(document).ready(function ($){
        ...
        function updateImageUploadOption() {
            ...
            if (provider === 'OpenAI') {
                // Enable image upload forgpt-4-vision-preview, gpt-4o, and gpt-4o-mini	
                if (model === 'gpt-4-vision-preview' || model === 'gpt-4o' || model === 'gpt-4o-mini') {
                ...
                if (model === 'openai/gpt-4-vision-preview' || model === 'openai/gpt-4o' || model === 'openai/gpt-4o-2024-05-13' || model === 'openai/gpt-4o-mini' || model === 'openai/gpt-4o-mini-2024-07-18') {
                    $imageUploadCheckbox.prop('disabled', false); // Enable the image upload checkbox
                } else {
                    $imageUploadCheckbox.prop('disabled', true).prop('checked', false); // Disable and uncheck the image upload checkbox
                }
        ...
        // Check if the feedback checkbox is checked on page load, if yes, check the save logs checkbox too
        if($('#wpaicgchat_feedback_btn').prop('checked')) {
            $('#wpaicg_chatbot_save_logs').prop('checked', true).trigger('change');
        }

        // Listen for changes to the feedback checkbox and if it's checked, enable the save logs checkbox
        $(document).on('change', '#wpaicgchat_feedback_btn', function(e){
...
<script>
document.addEventListener("DOMContentLoaded", function() {
    var useAvatarCheckbox = document.getElementById('wpaicg_chat_shortcode_use_avatar');
    var avatarSection = document.getElementById('avatar-section'); // Assume you wrap the avatar content in a div with this id

    function toggleAvatarSection() {
        if (useAvatarCheckbox.checked) {
    ...
    // Add event listener to toggle section when checkbox is changed
    useAvatarCheckbox.addEventListener('change', toggleAvatarSection);
});
</script>
<script>
    // Enable or disable the User Voice Switch based on the Text to Speech option
    document.getElementById('wpaicg_chat_to_speech').addEventListener('change', function() {
        const audioBtn = document.getElementById('wpaicgchat_audio_btn');
        // wpaicgchat_muted_by_default
        const mutedByDefault = document.getElementById('wpaicgchat_muted_by_default');
        audioBtn.disabled = !this.checked;
        mutedByDefault.disabled = !this.checked;
    });
</script>