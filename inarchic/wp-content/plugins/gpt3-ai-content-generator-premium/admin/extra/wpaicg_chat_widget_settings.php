        ...
        foreach($wpaicg_keys as $wpaicg_key){
            if(isset($_POST[$wpaicg_key]) && !empty($_POST[$wpaicg_key])){
                ...
                if ($wpaicg_key === 'wpaicg_chat_widget' && is_array($posted_value)) {
                    ...
                    // If feedback button is enabled, also enable save_logs (feedback_btn)
                    if (isset($sanitized_value['feedback_btn']) && $sanitized_value['feedback_btn']) {
                        $sanitized_value['save_logs'] = true;
                    }
...
$wpaicg_chat_widget_audio_btn = isset($wpaicg_chat_widget['audio_btn']) && !empty($wpaicg_chat_widget['audio_btn']) ? $wpaicg_chat_widget['audio_btn'] : false;
$wpaicg_chat_widget_muted_by_default = isset($wpaicg_chat_widget['muted_by_default']) && !empty($wpaicg_chat_widget['muted_by_default']) ? $wpaicg_chat_widget['muted_by_default'] : false;
        ...
        <form action="" method="post" id="form-chatbox-setting">
            ...
            <section id="aisettings" class="tab-content">
                ...
                <legend><?php echo esc_html__('Options', 'gpt3-ai-content-generator'); ?></legend>
                    <div class="nice-form-group">
                        <input <?php echo isset($wpaicg_chat_widget['internet_browsing']) && $wpaicg_chat_widget['internet_browsing'] ? ' checked' : '' ?> value="1" type="checkbox" name="wpaicg_chat_widget[internet_browsing]" id="wpaicg_chat_widget_internet_browsing">
                        <label for="wpaicg_chat_widget_internet_browsing"><?php echo esc_html__('Internet Browsing', 'gpt3-ai-content-generator'); ?></label>
                    </div>
                    <div class="nice-form-group">
            ...
            <section id="customtext" class="tab-content" style="display: none;">
                ...
                <div style="display: flex;justify-content: space-between;align-items: center;margin-top: -2em;">      
                    <div class="nice-form-group">
                        <label><?php echo esc_html__('Widget (75x75)','gpt3-ai-content-generator')?></label>
                        <div style="display: inline-flex; align-items: center">
                            ...
                            <div>
                                <img style="display: block" width="30" height="30" src="<?php echo esc_html(WPAICG_PLUGIN_URL).'admin/images/chatbot.png'?>">
                            ...
                            <div>
                                <div class="wpaicg_chatbox_icon">
                                    ...
                                    if(!empty($wpaicg_chat_icon_url) && $wpaicg_chat_icon == 'custom'):
                                        ...
                                        ?>
                                        <img src="<?php echo esc_html($wpaicg_chatbox_icon_url)?>" width="30" height="30">
                                    <?php else: ?>
                                        <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M246.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-128 128c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 109.3V320c0 17.7 14.3 32 32 32s32-14.3 32-32V109.3l73.4 73.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-128-128zM64 352c0-17.7-14.3-32-32-32s-32 14.3-32 32v64c0 53 43 96 96 96H352c53 0 96-43 96-96V352c0-17.7-14.3-32-32-32s-32 14.3-32 32v64c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V352z"/></svg><br>
                                    <?php endif; ?>
                                </div>
                    ...
                    <fieldset class="nice-form-group">
                    <legend><?php echo esc_html__('Position', 'gpt3-ai-content-generator'); ?></legend>
                        <div class="nice-form-group">
                    ...
                    <div class="nice-form-group">
                        <label><?php echo esc_html__('Delay','gpt3-ai-content-generator')?></label>
                        <input placeholder="<?php echo esc_html__('5','gpt3-ai-content-generator')?>" value="<?php echo esc_html($wpaicg_delay_time)?>" type="text" class="wpaicgchat_delay_time" name="wpaicg_chat_widget[delay_time]" style="max-width: 50px;">
                    </div>
                </div>
                ...
                <div class="nice-form-group">
                    <fieldset class="nice-form-group">
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                            <input <?php echo isset($wpaicg_chat_fullscreen) && $wpaicg_chat_fullscreen ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_widget[fullscreen]" id="wpaicgchat_widget_fullscreen">
                            <label for="wpaicgchat_widget_fullscreen" style="margin-left: 5px;">
                                <?php echo esc_html__('Fullscreen', 'gpt3-ai-content-generator') ?>
                            </label>
                        </div>
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                            <input <?php echo isset($wpaicg_chat_download_btn) && $wpaicg_chat_download_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_widget[download_btn]" id="wpaicgchat_widget_download_btn">
                            <label for="wpaicgchat_widget_download_btn" style="margin-left: 5px;">
                                <?php echo esc_html__('Download', 'gpt3-ai-content-generator') ?>
                            </label>
                        </div>
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                            <input <?php echo isset($wpaicg_chat_clear_btn) && $wpaicg_chat_clear_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_widget[clear_btn]" id="wpaicgchat_widget_clear_btn">
                            <label for="wpaicgchat_widget_clear_btn" style="margin-left: 5px;">
                                <?php echo esc_html__('Clear', 'gpt3-ai-content-generator') ?>
                            </label>
                        </div>
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                            <input <?php echo isset($wpaicg_chat_copy_btn) && $wpaicg_chat_copy_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_widget[copy_btn]" id="wpaicgchat_widget_copy_btn">
                            <label for="wpaicgchat_widget_copy_btn" style="margin-left: 5px;">
                                <?php echo esc_html__('Copy', 'gpt3-ai-content-generator') ?>
                            </label>
                        </div>
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                            <input <?php echo isset($wpaicg_chat_feedback_btn) && $wpaicg_chat_feedback_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_widget[feedback_btn]" id="wpaicgchat_widget_feedback_btn">
                            <label for="wpaicgchat_widget_feedback_btn" style="margin-left: 5px;">
                                <?php echo esc_html__('Feedback', 'gpt3-ai-content-generator') ?>
                            </label>
                        </div>
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                            <input <?php echo isset($wpaicg_chat_close_btn) && $wpaicg_chat_close_btn ? ' checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_widget[close_btn]" id="wpaicgchat_widget_close_btn">
                            <label for="wpaicgchat_widget_close_btn" style="margin-left: 5px;">
                                <?php echo esc_html__('Close', 'gpt3-ai-content-generator') ?>
                            </label>
                        </div>
                        <div class="nice-form-group" style="display: flex; align-items: center;">
                            <input id="wpaicg_use_avatar" <?php echo $wpaicg_use_avatar ? ' checked':''?> value="1" type="checkbox" class="wpaicgchat_use_avatar" name="wpaicg_chat_widget[use_avatar]">
                ...
                <div id="avatarIconArea" class="nice-form-group">
                ...
                <div class="nice-form-group">
                    ...
                    <input type="text" name="_wpaicg_ai_thinking" value="<?php echo esc_html( get_option( '_wpaicg_ai_thinking', __('Gathering thoughts','gpt3-ai-content-generator') ) ) ;?>" >
                </div>
                <div class="nice-form-group">
                ...
                <div class="nice-form-group">
                    ...
                    <input type="text" name="_wpaicg_chatbox_welcome_message" value="<?php echo esc_html( get_option( '_wpaicg_chatbox_welcome_message', __('Hello, how can I help you today?','gpt3-ai-content-generator') ) ) ;?>" >
                </div>
                <div class="nice-form-group">
                ...
                <div class="nice-form-group">
                    ...
                    <input value="<?php echo esc_html($wpaicg_chat_feedback_title)?>" class="wpaicg-feedback-title" type="text" name="wpaicg_chat_widget[feedback_title]" placeholder="<?php echo esc_html__('Feedback','gpt3-ai-content-generator')?>">
                </div>
                <!-- feedback message -->
                <div class="nice-form-group">
                    <label><?php echo esc_html__('Feedback Message','gpt3-ai-content-generator')?></label>
                    <input value="<?php echo esc_html($wpaicg_chat_feedback_message)?>" class="wpaicg-feedback-message" type="text" name="wpaicg_chat_widget[feedback_message]" placeholder="<?php echo esc_html__('Please provide details: (optional)','gpt3-ai-content-generator')?>">
                </div>
                <!-- feedback success message -->
                <div class="nice-form-group">
                    <label><?php echo esc_html__('Feedback Success Message','gpt3-ai-content-generator')?></label>
                    <input value="<?php echo esc_html($wpaicg_chat_feedback_success)?>" class="wpaicg-feedback-success" type="text" name="wpaicg_chat_widget[feedback_success]" placeholder="<?php echo esc_html__('Thank you for your feedback!','gpt3-ai-content-generator')?>">
                </div>
                <details>
                    <summary>
                        <button class="button button-primary wpaicg-w-25" name="wpaicg_submit"><?php echo esc_html__('Save','gpt3-ai-content-generator')?></button>
            ...
            <section id="knowledge" class="tab-content" style="display: none;">
                ...
                <div class="nice-form-group">
                    ...
                    <input id="wpaicg_confidence_score" name="wpaicg_chat_widget[confidence_score]" type="range" step="1" min="1" max="100" value="<?php echo isset($wpaicg_chat_widget['confidence_score']) ? esc_attr($wpaicg_chat_widget['confidence_score']) : 20; ?>" oninput="this.nextElementSibling.value = this.value">
                    <output><?php echo isset($wpaicg_chat_widget['confidence_score']) ? esc_attr($wpaicg_chat_widget['confidence_score']) : 20; ?></output>
                </div>
            ...
            <h3 style="margin-top: -1em;"><?php echo esc_html__('Speech','gpt3-ai-content-generator')?></h3>
                ...
                <!-- User Voice Switch -->
                <div class="nice-form-group" style="display: flex; align-items: center;">
                    <input <?php echo isset($wpaicg_chat_widget_audio_btn) && $wpaicg_chat_widget_audio_btn ? 'checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_widget[audio_btn]" id="wpaicgchat_widget_audio_btn" <?php echo $wpaicg_chat_to_speech ? '' : 'disabled'; ?>>
                    <label for="wpaicgchat_widget_audio_btn" style="margin-left: 5px;">
                        <?php echo esc_html__('Allow users to switch voice on/off', 'gpt3-ai-content-generator'); ?>
                    </label>
                </div>
                <div class="nice-form-group" style="display: flex; align-items: center;">
                    <input <?php echo isset($wpaicg_chat_widget_muted_by_default) && $wpaicg_chat_widget_muted_by_default ? 'checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_widget[muted_by_default]" id="wpaicgchat_widget_muted_by_default" <?php echo $wpaicg_chat_to_speech ? '' : 'disabled'; ?>>
                    <label for="wpaicgchat_widget_muted_by_default" style="margin-left: 5px;">
                ...
                <div class="wpaicg_voice_service_google" style="<?php echo $wpaicg_chat_voice_service == 'google' && !empty($wpaicg_google_api_key) ? '' : 'display:none'?>">
                    ...
                    <div class="nice-form-group" style="display: flex; gap: 20px; align-items: center;">
                        <div class="nice-form-group">
                            <label><?php echo esc_html__('Device','gpt3-ai-content-generator')?></label>
...
<script>
    jQuery(document).ready(function ($){
        ...
        $('.wpaicg_chat_widget_audio,.wpaicg_chat_widget_image,.wpaicgchat_use_avatar,.wpaicgchat_fullscreen,.wpaicgchat_close_btn,.wpaicgchat_download_btn,.wpaicgchat_clear_btn,.wpaicgchat_widget_audio_btn,.wpaicgchat_widget_muted_by_default').click(function(){
            wpaicgUpdateRealtime();
        })
...
<script>
    jQuery(document).ready(function($) {
    // Function to toggle the visibility of the avatar icon area
    function toggleAvatarIconArea() {
        if ($('#wpaicg_use_avatar').is(':checked')) {
            $('#avatarIconArea').show();
        } else {
            $('#avatarIconArea').hide();
        }
    ...
    // Initial check on page load
    toggleAvatarIconArea();

    // On change of the "Use Avatar" checkbox
    $('#wpaicg_use_avatar').change(function() {
        toggleAvatarIconArea();
    });
});
</script>